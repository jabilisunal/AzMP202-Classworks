// function decleration, expression, anonimous,
...
// default value
// function abstactNumber(number1=10,number2=50){
//     console.log(number1-number2);
// }
// abstactNumber(0,5)
...
// console.log(twoNumber(3,4))
// console.log(twoNumber(10,4))

// let ededler= [1,2,3,4,5]
// console.log(sumArray(ededler));
...
// console.log("ededlerin cemi sum methodu " +sumArray([1,2,3,4,5]));

// function avearage(arr){
//     let edediOrta = sumArray(arr)/arr.length;
//     return edediOrta
// }
// console.log(avearage([1,2,3,4,5,6]));
...
// let sayHi = function(username,surname){
//     return `Hello ${username} - ${surname}`
// }
// console.log(sayHi("Narmin","Jabbarova"));
// console.log(sayHi("Xadija","Bilalova"));

// let findNumber = function(number){
//     if(number%2==0){
...
//     return maxNum;
// }
// console.log(findMaxNumber([10,12,14,15,50]));
...
// if (reverse == text) {
//   console.log("this is polidrom");
// } else {
//   console.log("this is not polidrom");
// }
...
//   }else{
//     return ` this character is not wolve  ----${character}`;
//   }
// };
