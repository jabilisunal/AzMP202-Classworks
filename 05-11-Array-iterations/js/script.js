...
// const maxNum = milks.find((element) => {
//   let maxPrice = milks[0];
//   if (element > maxPrice.price) {
//     maxPrice = element.price;
//   }
//   return maxPrice.name
// });
// console.log(maxNum.name);
...
let newArray = products.filter((item)=>item.category==="electronics").map((elem)=>{return elem.price*=0.5;})
